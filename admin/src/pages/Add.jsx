            ...
            <div className="w-[100%] h-[100%] flex items-center justify-start ">
              ...
              >
                ...
                <input
                  ...
                  hidden
                  onChange={(e) => setImage4(e.target.files[0])}
                  // Remove required attribute for image4
                />
              </label>
            </div>
          </div>
         ...
         cursor-pointer bg-slate-600 px-[20px] text-[18px] placeholder:text-[#ffffffc2]"
          ...
          <div className="w-[80%] flex items-start justify-center flex-col  gap-[10px]">
            ...
            <textarea
              type="text"
              placeholder="Type here"
              className="w-[600px] max-w-[98%] h-[100px] rounded-lg hover:border-[#46d1f7] border-[2px] 
        cursor-pointer bg-slate-600 px-[20px] py-[10px] text-[18px] placeholder:text-[#ffffffc2]"
          ...
          <div className="w-[80%]  flex items-center  gap-[10px] flex-wrap ">
            <div className="md:w-[30%] w-[100%] flex items-start sm:justify-center flex-col  gap-[10px]">
              ...
              <select
                name=""
                id=""
                className="bg-slate-600 w-[60%] px-[10px] py-[7px] rounded-lg hover:border-[#46d1f7] 
           border-[2px] "
            ...
            <div className="md:w-[30%] w-[100%] flex items-start sm:justify-center flex-col  gap-[10px]">
              ...
              <select
                name=""
                id=""
                className="bg-slate-600 w-[60%] px-[10px] py-[7px] rounded-lg
          ...
          <div
            className="w-[80%] h-[220px] md:h-[100px] flex items-start justify-center flex-col gap-[10px] 
       py-[10px] md:py-[0px]"
          >
            <p className="text-[20px] md:text-[25px]  font-semibold">
              Product Size
            ...
            <div className="flex items-center justify-start gap-[15px] flex-wrap">
              <div
                className={`px-[20px] py-[7px] rounded-lg bg-slate-600 text-[18px] hover:border-[#46d1f7] 
            ...
            border-[2px] cursor-pointer ${
              ...
              <div
                className={`px-[20px] py-[7px] rounded-lg bg-slate-600 text-[18px] hover:border-[#46d1f7] border-[2px]
             cursor-pointer ${
               sizes.includes("L")
                 ? "bg-green-400 text-black border-[#46d1f7]"
                 : ""
